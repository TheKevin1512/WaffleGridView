...
public class WaffleGridView extends View {
    ...
    public WaffleGridView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public WaffleGridView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            this.color          = attributes.getColor(R.styleable.WaffleGridView_color, DEFAULT_COLOR);
            this.density        = attributes.getInt(R.styleable.WaffleGridView_density, DEFAULT_DENSITY);
            this.cols           = attributes.getInt(R.styleable.WaffleGridView_cols, DEFAULT_COLS);
            this.rows           = attributes.getInt(R.styleable.WaffleGridView_rows, DEFAULT_ROWS);
            attributes.recycle();
        }
